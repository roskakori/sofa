...
feature
   ...
   new_bar(c: CHARACTER): POINTER is
	 ...
	 -- CHARACTER). 
      external "C++ [new Bar %"Bar.h%"] (EIF_CHARACTER)"
      end;

   do_print_and_return(i: INTEGER): CHARACTER is
	 ...
	 -- yet done).
      external "C++ [static Bar %"Bar.h%" ] (EIF_INTEGER): char"
      end;
